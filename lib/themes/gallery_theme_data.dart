    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: IconThemeData(color: colorScheme.primary),
         toolbarTextStyle: _textTheme.apply(bodyColor: colorScheme.onPrimary).bodyMedium, titleTextStyle: _textTheme.apply(bodyColor: colorScheme.onPrimary).titleLarge,
      ),
