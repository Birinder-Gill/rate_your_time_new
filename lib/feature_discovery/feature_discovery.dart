...
//
//
// /// [Widget] to enforce a global lock system for [FeatureDiscoveryImpl] widgets.
// ///
// /// This widget enforces that at most one [FeatureDiscoveryImpl] widget in its
// /// widget tree is shown at a time.
// ///
// /// Users wanting to use [FeatureDiscoveryImpl] need to put this controller
// /// above [FeatureDiscoveryImpl] widgets in the widget tree.
...
//
//   /// Flag to indicate whether a [FeatureDiscoveryImpl] widget descendant is
//   /// currently showing its overlay or not.
//   ///
//   /// If true, then no other [FeatureDiscoveryImpl] widget should display its
//   /// overlay.
...
//   /// by the first [FeatureDiscoveryImpl] ready to show its overlay, and any
//   /// additional [FeatureDiscoveryImpl] widgets wanting to show their overlays
...
// class FeatureDiscoveryImpl extends StatefulWidget {
...
//
//   @override
//   _FeatureDiscoveryImplState createState() => _FeatureDiscoveryImplState();
// }
//
// class _FeatureDiscoveryImplState extends State<FeatureDiscoveryImpl>
...
//     return Material(
//       key: FeatureDiscoveryImpl.overlayKey,
//       type: MaterialType.transparency,
//       child: Stack(
//         children: [
//           GestureDetector(
//             key: FeatureDiscoveryImpl.gestureDetectorKey,
//             onTap: dismiss,
//             child: Container(
...
//
//   @override
//   void didUpdateWidget(FeatureDiscoveryImpl oldWidget) {
